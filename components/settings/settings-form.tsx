            ...
            <aside aria-labelledby="api-channel-guide-heading">
              <CardContent className="space-y-3 pt-6 pb-6">
                ...
                <ol className="list-decimal space-y-2 pl-5 text-sm text-muted-foreground">
                  <li>
                    디스코드 앱에서 &apos;서버 설정 ⭢ 연동&apos;으로 이동한 후
                    센드베이스 설정으로 진입해 웹후크를 눌러, 메시지를 보내는
                    봇을 원하는 모습으로 변경할 수 있어요.
                  </li>
                  <li>
                    X에는 하루에 최대 3개의 글만 게시할 수 있어요. 모든 X API
                    비용을 센드베이스가 지불하고 있어, 양해 부탁드려요.
                  </li>
                </ol>
              </CardContent>
            </aside>
          ...
          <Card className="gap-0 py-0 [--card-spacing:--spacing(6)]">
            ...
            <aside className="border-t" aria-labelledby="board-guide-heading">
              <CardContent className="space-y-3 pt-6 pb-6">
                ...
                <ol className="list-decimal space-y-2 pl-5 text-sm text-muted-foreground">
                  <li>
                    네이버 카페는 공지를 작성할 게시판(카테고리)가 아닌
                    전체글보기를 눌러 주소창을 복사해서 붙여넣고, 게시판 이름에
                    따로 게시판의 이름을 동일하게 적어주셔야 해요.
                  </li>
                  <li>
                    SOOP 게시판은 전체게시판이 아닌, 공지를 쓸 세부 게시판으로
                    들어간 후 주소창을 복사해서 붙여넣어주세요. 글쓰기
                    화면까지는 들어가지 마세요.
                  </li>
                </ol>
              </CardContent>
